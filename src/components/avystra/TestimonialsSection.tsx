...
export default function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      className="relative py-12 bg-transparent border-none overflow-x-hidden md:py-20 scroll-mt-24"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 select-none">
        ...
        >
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="card-premium group relative rounded-3xl p-5 sm:p-8 lg:p-10 flex flex-col justify-between overflow-hidden"
            >
