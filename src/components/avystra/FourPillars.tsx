    ...
    >
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
        ...
        <div className="max-w-4xl mb-12 md:mb-16">
          <div
            ref={eyebrowRef}
            className="inline-flex items-center gap-2 bg-white/50 border border-slate-100 px-4 py-2 rounded-full mb-5 shadow-sm"
          >
        ...
        <div className="relative">
          ...
          >
            {pillars.map((pillar) => (
              ...
              >
                <div className="card-premium relative h-full bg-white/50 rounded-[1.75rem] p-6 sm:p-7 md:p-8 flex flex-col justify-between overflow-hidden transition-all duration-500 ease-out-expo group-hover:-translate-y-1.5 group-hover:shadow-[0_20px_50px_-15px_rgba(11,27,46,0.12)]">
